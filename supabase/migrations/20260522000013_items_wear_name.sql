...
alter table items add column if not exists wear_name wear_condition;
...
begin
  for v_entry in select * from jsonb_array_elements(p_entries) loop
    ...
    insert into items (market_hash_name, item_name, def_index, paint_index, float_min, float_max, icon_url, wear_name)
    values (
